...
class TradeRequestManagerTest {
    ...
    void onlyTargetCanAcceptIncomingRequest() {
        ...
        assertEquals(
                sender,
                TradeRequestManager.takeIncoming(target, 1_002L, COOLDOWN).senderId()
        );
    }
}
