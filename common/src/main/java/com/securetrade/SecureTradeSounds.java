...
public final class SecureTradeSounds {
    public static final Identifier TRADE_ITEM_ADD_ID = id("trade_item_add");
    public static final Identifier TRADE_ITEM_BLOCKED_ID = id("trade_item_blocked");
    public static final Identifier TRADE_CANCEL_ID = id("trade_cancel");
    public static final Identifier TRADE_COUNTDOWN_TICK_ID = id("trade_countdown_tick");
    public static final Identifier TRADE_REQUEST_SENT_ID = id("trade_request_sent");
    public static final Identifier TRADE_SUCCESS_ID = id("trade_success");
    ...
    private static Identifier id(String path) {
        return Identifier.fromNamespaceAndPath("securetrade", path);
    }
}
