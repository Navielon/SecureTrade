...
public class FabricSecureTradeMod implements ModInitializer {
    ...
    public static final Identifier TRADE_INVENTORY_WARNING_ID = new Identifier(MODID, "trade_inventory_warning");
    ...
    public void onInitialize() {
        ...
        ServerPlayConnectionEvents.DISCONNECT.register((handler, server) ->
                TradeSessionManager.cancelForPlayer(handler.player)
        );
    }
}
