...
public final class TradeInventoryCapacity {
    ...
    public static boolean canFit(Inventory inventory, SimpleContainer incoming) {
    ...
    static boolean canFit(List<ItemStack> currentSlots, SimpleContainer incoming) {
        ...
        return canFit(inventoryUnits, incomingUnits, ItemStack::isSameItemSameComponents);
    }
    ...
    private static StackUnit<ItemStack> toUnit(ItemStack stack) {
        ...
        return new StackUnit<>(stack.copyWithCount(1), stack.getCount(), stack.getMaxStackSize());
    }
